            ...
            {[
              {
                ...
                description:
                  "Sagar is the driving force behind our success. With extensive experience in digital marketing, SEO, Google Ads, and Facebook Ads, he crafts result-oriented strategies tailored to our clients' needs.",
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.05 }}
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${member.gradient} opacity-10`}></div>

                <div className="relative z-10">
                  <h3 className="text-xl font-bold mb-2 text-white">{member.title}</h3>
                  <p className="text-gray-300 font-semibold mb-2">{member.subTitle}</p>
